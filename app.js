...
const TOUR_STEPS = [
  {
    phase: 'Scene',
    title: 'You open NVDA after a rough day',
    body: 'Price is red. Something is clearly happening. Most people would scroll for answers right here on the stock page. Let\'s watch what they actually get today.',
    target: null,
    view: 'before',
  ...
  {
    phase: 'Notice',
    title: 'The page looks fine at first',
    body: 'Live price, a chart, a News section. It feels complete. Pause for a second though: would this tell you what people are suddenly saying about NVDA, or only that the market moved?',
    target: '#tour-before',
    view: 'before',
    nextLabel: 'Check the news',
  },
  {
    phase: 'The gap',
    title: 'Then you realize the blind spot',
    body: 'These headlines are the same for everyone. No chatter spike, no bull vs bear split, no "what should I do next." You can read all night and still not know what is actually moving the name.',
    target: '#tour-before-news',
    view: 'before',
    nextLabel: 'So what changes?',
  },
  {
    phase: 'The turn',
    title: 'What if the page answered that?',
    body: 'That missing layer is the opportunity. Tap After to see the same stock page with Cortex insight: sentiment, chatter, and a path to act without leaving Robinhood.',
    target: '#tab-after',
    view: 'before',
  ...
  {
    phase: 'After',
    title: 'Same stock. New awareness.',
    body: 'Price and chart are still here, so nothing familiar is taken away. The difference starts underneath: the page now tries to explain the move, not just report it.',
    target: '.col-chart',
    view: 'after',
  ...
  {
    phase: 'After',
    title: 'Now you see why it moved',
    body: 'Cortex surfaces the chatter spike, mixed sentiment, and a plain-language summary. The blind spot from Before becomes an answer in one card.',
    target: '#insight-card',
    view: 'after',
  ...
  {
    phase: 'After',
    title: 'And you can do something about it',
    body: 'Online chatter keeps the story alive, and GOLD opens a fuller breakdown plus an agentic rule. You went from "price is down" to "here\'s the debate, and a next step."',
    target: '.col-chatter',
    view: 'after',
    nextLabel: 'Finish',
  },
